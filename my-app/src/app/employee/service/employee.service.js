...
var EmployeeService = (function () {
    function EmployeeService(http) {
        this.http = http;
        this.employeesUrl = 'api/employees'; // URL to web api
    ...
    EmployeeService.prototype.update = function (employee) {
        var url = this.employeesUrl + "/" + employee.id; //the employees details page for the specific employee
        return this.http
            ...
            .toPromise().then(function () { return employee; })
            .catch(this.handleError);
    };
